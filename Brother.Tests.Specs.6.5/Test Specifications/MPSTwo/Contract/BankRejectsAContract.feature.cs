...
#line 1 "BankRejectsAContract.feature"
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Bank Can Rejects A Contract")]
        ...
        public virtual void BankCanRejectsAContract(string role, string country, string contract, string leasing, string billing, string printer, string clickVolume, string colourVolume, string role2, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Bank Can Rejects A Contract", exampleTags);
#line 8
...
#line 22
 testRunner.And("I reject the contract above", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 23
 testRunner.And("I sign out of Cloud MPS", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 24
...
#line 25
 testRunner.Then("the reject contract above is displayed on dealer rejected offer screen", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
