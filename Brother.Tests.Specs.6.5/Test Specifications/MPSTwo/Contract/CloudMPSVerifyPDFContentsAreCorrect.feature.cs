...
namespace Brother.Tests.Specs.TestSpecifications.MPSTwo.Contract
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSVerifyPDFContentsAreCorrect")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    [NUnit.Framework.CategoryAttribute("TEST")]
    public partial class CloudMPSVerifyPDFContentsAreCorrectFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSVerifyPDFContentsAreCorrect", "In order to ensure that PDF contents are correct when compared with Summary page\r" +
        ...
        public virtual void VerifyPDFContentsAreCorrect(string contractType, string usageType, string[] exampleTags)
        {
