...
#line 1 "BankCanMaintainOfferAfterADealerSignsContract.feature"
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Bank Can Maintain Offer After A Dealer Signs A Contract")]
        ...
        public virtual void BankCanMaintainOfferAfterADealerSignsAContract(string role, string country, string contract, string leasing, string billing, string printer, string clickVolume, string colourVolume, string role2, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Bank Can Maintain Offer After A Dealer Signs A Contract", exampleTags);
#line 8
...
#line 25
 testRunner.And("I sign the contract", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 26
 testRunner.And("I sign out of Cloud MPS", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 27
...
#line 28
 testRunner.Then("I can successfully maintain the customer for the signed contract", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
