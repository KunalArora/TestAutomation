...
#line hidden
        ...
        public virtual void InstallerCanProgressWithInstallationForCloudCommunication(string role, string country, string contractType, string usageType, string role1, string method, string[] exampleTags)
        {
...
#line 17
 testRunner.And("I enter the device serial number", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 18
