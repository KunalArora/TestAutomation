@TEST @UAT @MPS
Feature: CloudMPSPurchaseAndClickProposalUserJourney
...
Scenario Outline: Create different varieties of Purchase and Click proposal for new customer on Minimum Volume Term
	...
	| Cloud MPS Dealer | United Kingdom | Purchase & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Pay upfront   | 800         | 800          |
...
Scenario Outline: Create different varieties of Purchase and Click proposal for new customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | United Kingdom | Purchase & Click with Service | Create new customer | Pay As You Go | 4 years  | Quarterly in Arrears | Quarterly in Arrears | Tick        | MFC-8510DN | Full      | 750        |
...
Scenario Outline: Create different varieties of Purchase and Click proposal for an existing customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | United Kingdom | Purchase & Click with Service | Pay As You Go | 5 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-8510DN | Full         | 750        |
