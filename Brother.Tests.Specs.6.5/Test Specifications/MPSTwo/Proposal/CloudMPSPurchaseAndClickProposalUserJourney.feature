...
Scenario Outline: Create different varieties of Purchase and Click proposal for new customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Spain          | Purchase & Click con Service  | Create new customer | Pago por Uso                                   | 4 años   | Quarterly in Arrears           | Tick          | MFC-8510DN   | Full         | 750                 |
...
Scenario Outline: Create different varieties of Purchase and Click proposal for an existing customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Spain          | Purchase & Click con Service  | Pago por Uso                                   | 5 años   | Quarterly in Arrears           | Tick          | MFC-8510DN | Full         | 750         |
