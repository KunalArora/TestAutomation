@MPS @UAT @TEST
Feature: MPS Proposal - Add a devices to a proposal during creation
...
Scenario Outline: Lease and Click product screen validation
	...
	| Cloud MPS Dealer | United Kingdom | Lease & Click with Service      | 3 years  | Quarterly in Arrears | Quarterly in Arrears | DCP-8250DN   |
