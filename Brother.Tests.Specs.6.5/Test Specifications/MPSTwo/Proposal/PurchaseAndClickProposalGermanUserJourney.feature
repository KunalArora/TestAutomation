...
Scenario Outline: Create different varieties of German Purchase and Click proposal for new customer on Minimum Volume Term
	...
	| Cloud MPS Dealer | Germany | Purchase & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly | Quarterly | Tick          | MFCL8650CDW | Full         |  Pay upfront  | 2000        | 2000         |
...
Scenario Outline: Create different varieties of German Purchase and Click proposal for new customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Germany | Purchase & Click with Service | Create new customer | Pay As You Go | 4 years  | Quarterly | 3 Monthly | Untick        | MFC8510DN | Reduced      | 5000        |
...
Scenario Outline: Create different varieties of German Purchase and Click proposal for an existing customer
	...
	| Cloud MPS Dealer | Germany | Purchase & Click with Service | Minimum Volume | 3 years  | Quarterly | Quarterly | Untick          | MFCL8650CDW | Full         | Included in Click Price | 2000        | 2000         |
...
Scenario Outline: Create different varieties of German Purchase and Click proposal for an existing customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Germany | Purchase & Click with Service | Pay As You Go | 5 years  | Quarterly | Quarterly | Tick          | MFC8510DN | Full         | 3000        |
