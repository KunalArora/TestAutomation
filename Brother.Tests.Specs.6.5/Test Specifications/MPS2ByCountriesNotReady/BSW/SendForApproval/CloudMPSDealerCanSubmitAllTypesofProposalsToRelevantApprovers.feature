@MPS @TEST @UAT
Feature: CloudMPSSwissDealerSubmitAllTypesofProposalsToRelevantApprovers
...
Scenario Outline: Send certain proposals for approval
	...
	| Cloud MPS Dealer | Switzerland | Cloud MPS Local Office Approver | Buy & Click  | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata |
...
Scenario Outline: Send certain approval for Privately Liable Customer
	...
	| Cloud MPS Dealer | Switzerland | Cloud MPS Local Office Approver | Buy & Click  | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata | Autre   |
