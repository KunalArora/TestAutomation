...
namespace Brother.Tests.Specs.TestSpecifications.MPS2ByCountriesNotReady.BBE.Customer
{
    ...
    [NUnit.Framework.DescriptionAttribute("BelgianCustomerCanPerformSomeRunActions")]
    [NUnit.Framework.IgnoreAttribute()]
    [NUnit.Framework.CategoryAttribute("TEST")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    public partial class BelgianCustomerCanPerformSomeRunActionsFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "BelgianCustomerCanPerformSomeRunActions", "In order for customer to perform some run portion actions\r\nAs a customer\r\nI want " +
        ...
        [NUnit.Framework.DescriptionAttribute("Belgian Customer cannot order consumable before initial communication with device" +
            "")]
        ...
        public virtual void BelgianCustomerCannotOrderConsumableBeforeInitialCommunicationWithDevice(string role, string country, string contractType, string usageType, string role1, string method, string role2, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Belgian Customer cannot order consumable before initial communication with device" +
                    "", exampleTags);
#line 8
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Belgian Customer can order consumable after initial communication with device")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Customer", "United Kingdom", null)]
        public virtual void BelgianCustomerCanOrderConsumableAfterInitialCommunicationWithDevice(string role, string country, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Belgian Customer can order consumable after initial communication with device", exampleTags);
#line 28
this.ScenarioSetup(scenarioInfo);
#line 29
