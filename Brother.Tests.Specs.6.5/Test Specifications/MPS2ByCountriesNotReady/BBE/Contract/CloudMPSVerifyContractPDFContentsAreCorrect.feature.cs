...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Verify Belgian PDF Contents Are Correct")]
        [NUnit.Framework.TestCaseAttribute("Purchase & Click with Service", "Minimum Volume", null)]
        public virtual void VerifyBelgianPDFContentsAreCorrect(string contractType, string usageType, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Belgian PDF Contents Are Correct", exampleTags);
#line 8
