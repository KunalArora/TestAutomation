...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 ans  | Quarterly in Arrears | Web  |
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 ans  | Quarterly in Arrears | BOR  |
