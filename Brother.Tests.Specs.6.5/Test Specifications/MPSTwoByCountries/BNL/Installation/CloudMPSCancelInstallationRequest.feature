...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | BOR  | 3 years | Quarterly in Arrears |
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Email  | 3 years | Quarterly in Arrears |
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 years | Quarterly in Arrears | Web  |
	| Cloud MPS Local Office Approver | Netherlands | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 years | Quarterly in Arrears | BOR  |
