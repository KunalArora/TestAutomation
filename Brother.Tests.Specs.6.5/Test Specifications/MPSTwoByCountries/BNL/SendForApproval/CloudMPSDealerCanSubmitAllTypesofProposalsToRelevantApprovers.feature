@MPS @TEST @UAT
Feature: CloudMPSDutchDealerSubmitAllTypesofProposalsToRelevantApprovers
...
Scenario Outline: Send certain approval for Privately Liable Customer
	...
	| Cloud MPS Dealer | Netherlands | Cloud MPS Local Office Approver | Buy & Click  | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata | Autre   |
