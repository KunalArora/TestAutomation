...
namespace Brother.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC112.BNS.Proposal
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSSwedishDealerCanDeleteProposal")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("TEST")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    public partial class CloudMPSSwedishDealerCanDeleteProposalFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSSwedishDealerCanDeleteProposal", "In order to stop the progress of a proposal\r\nAs a math dealer\r\nI want to be able " +
        ...
        [NUnit.Framework.DescriptionAttribute("MPS Swedish Dealers can delete an open Purchase and Click proposal")]
        ...
        public virtual void MPSSwedishDealersCanDeleteAnOpenPurchaseAndClickProposal(string role, string country, string role2, string contractType, string usageType, string length, string billing, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPS Swedish Dealers can delete an open Purchase and Click proposal", exampleTags);
#line 8
