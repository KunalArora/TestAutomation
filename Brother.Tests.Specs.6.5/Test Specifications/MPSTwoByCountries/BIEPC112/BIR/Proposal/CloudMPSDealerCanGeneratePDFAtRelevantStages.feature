@MPS @TEST @UAT
Feature: CloudMPSIrishDealerCanGeneratePDFAtRelevantStages
	In order to generate Proposal PDF
	As a dealer
	I want to create a proposal for which a PDF for which a proposal can be downloaded


Scenario Outline: MPS Irish Dealer Can Generate PDF Purchase and Click Minimum Summary Page
	...
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Minimum Volume | 3 years  | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Included in Click Price | 2000        | 2000         |
	

Scenario Outline: MPS Irish Dealer Can Generate PDF for Purchase and Click in Awaiting Approval Status for other countries
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
