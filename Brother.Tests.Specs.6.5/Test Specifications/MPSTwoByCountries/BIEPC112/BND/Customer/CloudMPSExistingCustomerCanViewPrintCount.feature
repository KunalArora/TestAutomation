@MPS @UAT @TEST
Feature: CloudMPSCreateAContractWithExistingDannishCustomer
	In order to work with customer run portion
	As a dealer
	I want to be able to create a contract with an existing customer


Scenario Outline: MPS Danish Existing Customer can be used to create a new contract for Run purpose
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Denmark | Køb & Klik med service | Minimumsvolumen | Cloud MPS Dealer | Cloud  | Web  | Aurelio20160630151142@mailinator.com | 3 år   | Quarterly in Arrears | Cloud MPS Customer |
