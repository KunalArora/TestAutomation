...
Scenario Outline: MPS Create MV Proposal
	...
	| Cloud MPS Dealer | Belgium | Buy & Click                   | Create new customer | Volume minimum | 3 ans    | Jaarlijke afrekening / Décompte annuel | Tick          | MFC-L8650CDW | Full         | Paiement au démarrage du contrat      | 800         | 800          | French   |
...
Scenario Outline: MPS Create Proposal With Existing Customer
	...
	| Cloud MPS Dealer | Belgium | Buy & Click                   | Volume minimum | 3 ans    | Jaarlijke afrekening / Décompte annuel                             | Tick          | MFC-L8650CDW | Full         | Inclus dans le prix click   | 800         | 800          | French   |
