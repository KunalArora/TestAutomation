...
Scenarios: 
	...
	| Cloud MPS Dealer | Belgium | Buy & Click                   | Volume minimum | 3 ans    | Driemaandelijks, betaling vooraf / Paiement trimestriel à l’avance | Tick          | MFC-L8650CDW | Full         | Inclus dans le prix click   | 800         | 800          | Inclus dans le prix click   | Paiement au démarrage du contrat      | French   |
