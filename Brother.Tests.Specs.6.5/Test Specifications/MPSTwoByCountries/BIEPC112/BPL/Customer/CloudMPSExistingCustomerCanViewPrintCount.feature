...
Scenario Outline: MPS Polish Existing Customer can be used to create a new contract for Run purpose
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Poland  | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | Web  | lashonda20160322123145@mailinator.com | 3 years | Quarterly in Arrears | Cloud MPS Customer |
