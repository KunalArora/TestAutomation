...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("MPS Dutch Dealers can delete an open Purchase and Click proposal")]
        ...
        public virtual void MPSDutchDealersCanDeleteAnOpenPurchaseAndClickProposal(string role, string country, string role2, string contractType, string usageType, string length, string billing, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPS Dutch Dealers can delete an open Purchase and Click proposal", exampleTags);
#line 9
