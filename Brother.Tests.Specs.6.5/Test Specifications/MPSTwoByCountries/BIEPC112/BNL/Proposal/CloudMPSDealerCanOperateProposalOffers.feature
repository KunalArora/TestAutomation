...
@ignore
Scenario Outline: MPS Dutch Dealer can copy an existing proposal offer for all countries
	...
	| Cloud MPS Dealer | Netherlands | Purchase + Click met Service | Minimumvolume | 3 jaar | Quarterly in Arrears | Skip customer creation | Without |
	| Cloud MPS Dealer | Netherlands | Purchase + Click met Service | Minimumvolume | 4 jaar | Quarterly in Arrears | Create new customer    | With    |
