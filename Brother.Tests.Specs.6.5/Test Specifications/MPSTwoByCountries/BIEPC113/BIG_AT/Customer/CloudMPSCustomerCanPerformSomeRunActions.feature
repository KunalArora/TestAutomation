...
Scenario Outline: MPS GermanyAustria Customer cannot order consumable before initial communication with device
...
Scenario Outline: MPS GermanyAustria Customer can order consumable after initial communication with device
