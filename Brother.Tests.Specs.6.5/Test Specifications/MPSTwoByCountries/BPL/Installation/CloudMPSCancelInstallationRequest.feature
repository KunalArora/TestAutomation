@MPS @UAT @TEST
Feature: CloudMPSPolishDealerCancelInstallationRequest
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Poland  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Cloud  | Web  | 3 ans  | Trimestrale anticipata |
	| Cloud MPS Local Office Approver | Poland  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Cloud  | BOR  | 4 ans  | Trimestrale anticipata |
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Poland  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Email  | 3 ans  | Trimestrale anticipata |
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Poland  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Cloud  | 3 ans  | Trimestrale anticipata | Web  |
	| Cloud MPS Local Office Approver | Poland  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Cloud  | 3 ans  | Trimestrale anticipata | BOR  |
