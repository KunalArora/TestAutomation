...
Scenario Outline: Dealer can edit an existing proposal offer
	...
	| Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Sweden | TermAndType         |
...
Scenario Outline: Dealer can edit products in an existing proposal offer
	...
	| Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Sweden  | Products | Add    |
	| Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Sweden  | Products | Remove |
...
Scenario Outline: Dealer can cancel deleting proposal offer
	...
	| Cloud MPS Dealer | Sweden  | Dismiss | AnyItem    |
...
Scenario Outline: Dealer can copy an existing proposal offer for all countries
	...
	| Cloud MPS Dealer | Sweden  | Buy & Click  | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata | Skip customer creation | Without |
	| Cloud MPS Dealer | Sweden  | Buy & Click  | Engagement sur un minimum volume de pages | 4 ans  | Trimestrale anticipata | Create new customer    | With    |
