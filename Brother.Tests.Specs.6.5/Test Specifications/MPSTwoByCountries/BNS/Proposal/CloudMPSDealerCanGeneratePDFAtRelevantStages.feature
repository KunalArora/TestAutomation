@MPS @TEST @UAT
Feature: CloudMPSSwedishDealerCanGeneratePDFAtRelevantStages
...
Scenario Outline: Dealer Can Generate PDF Purchase and Click Minimum Summary Page
	...
	| Cloud MPS Dealer | Sweden  | Purchase & Click with Service | Minimum Volume | 3 years  | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Included in Click Price | 2000        | 2000         |
