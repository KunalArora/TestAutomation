...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Switzerland | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Email  | Cloud MPS Customer |
...
Scenarios:
	...
	| Role               | Country     |
	| Cloud MPS Customer | Switzerland |
