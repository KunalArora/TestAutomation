@ignore @TEST @UAT @MPS
Feature: CloudMPSNorwegianLeasingAndClickProposalUserJourney
...
Scenario Outline: Create different varieties of Leasing and Click proposal for new customer
	...
	| Cloud MPS Dealer | United Kingdom | Lease & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly in Arrears | Quarterly in Arrears | HL-L8350CDW | Full         | 750        | 750         |
