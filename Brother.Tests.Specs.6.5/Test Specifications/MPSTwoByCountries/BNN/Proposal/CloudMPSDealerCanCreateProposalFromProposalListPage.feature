@MPS @UAT @TEST
Feature: CloudMPSNorwegianDealerCanCreateProposalFromProposalListPage
...
Scenarios: 
	...
	| Cloud MPS Dealer | Norway  | Purchase & Click with Service | Minimum Volume | 3 years  | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Included in Click Price | 800         | 800          | Included in Click Price | Pay upfront |
