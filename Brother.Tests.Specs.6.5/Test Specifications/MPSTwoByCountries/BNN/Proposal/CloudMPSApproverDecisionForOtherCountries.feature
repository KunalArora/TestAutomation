@MPS @TEST @UAT
Feature: CloudMPSNorwegianApproverDecisionFeature
...
Scenario Outline: Approver Decline Proposal for other Countries
	...
	| Norway  | Cloud MPS Local Office Approver | Buy & Click                       | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata  |
...
Scenario Outline: Belgian Local Office Approver can view confirmed/rejected/signed contracts for other Countries
	...
	| Cloud MPS Local Office Approver | Norway  | Awating Acceptance |
	| Cloud MPS Local Office Approver | Norway  | Rejected           |
	| Cloud MPS Local Office Approver | Norway  | Accepted           |
