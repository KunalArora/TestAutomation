@MPS @UAT @TEST
Feature: CloudMPSFinnishDealerCancelInstallationRequest
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Finland | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 years | Quarterly in Arrears | Web  |
	| Cloud MPS Local Office Approver | Finland | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | 3 years | Quarterly in Arrears | BOR  |
