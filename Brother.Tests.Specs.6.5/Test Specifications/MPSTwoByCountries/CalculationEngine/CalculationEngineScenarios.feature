...
Scenarios:
	...
	#| Cloud MPS Local Office Approver | Denmark        | Purchase & Click with Service      | Minimumsvolumen                           | Cloud MPS Dealer | Cloud  | BOR  | 3 år    | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010033    | A1T010034     | A1T010035     | A1T010036     |
	#| Cloud MPS Local Office Approver | Sweden         | Purchase & click inklusive service | Minimum volym                             | Cloud MPS Dealer | Cloud  | BOR  | 36      | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010037    | A1T010038     | A1T010039     | A1T010040     |
	...
	#| Cloud MPS Local Office Approver | Belgium        | Purchase & Click with Service      | Minimum Volume                            | Cloud MPS Dealer | Cloud  | BOR  | 3 jaar  | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010061    | A1T010062     | A1T010063     | A1T010064     |
	...
	#| Cloud MPS Local Office Approver | Finland        | Purchase & Click with Service      | Minimitulostusmäärä                       | Cloud MPS Dealer | Cloud  | BOR  | 3 vuotta| Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010057    | A1T010058     | A1T010059     | A1T010060     |
	#| Cloud MPS Local Office Approver | Switzerland    | Purchase & Click with Service      | Mindestvolumen                            | Cloud MPS Dealer | Cloud  | BOR  | 3 Jahre | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010065    | A1T010066     | A1T010067     | A1T010068     |
...
Scenarios:
	...
	#| Cloud MPS Local Office Approver | Denmark        | Purchase & Click with Service      | Minimumsvolumen                           | Cloud MPS Dealer | Cloud  | BOR  | 4 år     | Half Yearly  | Included in Click Price | Brother      | No       | MFC-L8650CDW | MFC-L5750DW | A1T010089    | A1T010090     | A1T010091     | A1T010092     |
	#| Cloud MPS Local Office Approver | Sweden         | Purchase & click inklusive service | Minimum volym                             | Cloud MPS Dealer | Cloud  | BOR  | 48       | Half Yearly  | Included in Click Price | Brother      | No       | MFC-L8650CDW | MFC-L5750DW | A1T010093    | A1T010094     | A1T010095     | A1T010096     |
	...
	| Cloud MPS Local Office Approver | Belgium        | Purchase & Click with Service      | Minimum Volume                            | Cloud MPS Dealer | Cloud  | BOR  | 4 jaar   | Half Yearly  | Included in Click Price | Brother      | No       | MFC-L8650CDW | MFC-L5750DW | A1T010121    | A1T010122     | A1T010123     | A1T010124     |
	#| Cloud MPS Local Office Approver | Germany        | Easy Print Pro & Service           | Mindestvolumen                            | Cloud MPS Dealer | Cloud  | BOR  | 3 Jahre  | Halbjährlich | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010129    | A1T010130     | A1T010131     | A1T010132     |
	#| Cloud MPS Local Office Approver | Austria        | Easy Print Pro & Service           | Mindestvolumen                            | Cloud MPS Dealer | Cloud  | BOR  | 3 Jahre  | Halbjährlich | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010133    | A1T010134     | A1T010135     | A1T010136     |
	...
	#| Cloud MPS Local Office Approver | Switzerland    | Purchase & Click with Service      | Mindestvolumen                            | Cloud MPS Dealer | Cloud  | BOR  | 4 Jahre  | Half Yearly  | Included in Click Price | Brother      | No       | MFC-L8650CDW | MFC-L5750DW | A1T010125    | A1T010126     | A1T010127     | A1T010128     |
	#| Cloud MPS Local Office Approver | Finland        | Purchase & Click with Service      | Minimitulostusmäärä                       | Cloud MPS Dealer | Cloud  | BOR  | 4 vuotta | Half Yearly  | Included in Click Price | Brother      | No       | MFC-L8650CDW | MFC-L5750DW | A1T010117    | A1T010118     | A1T010119     | A1T010120     |
	#
...
Scenarios:
	...
	#| Cloud MPS Local Office Approver | Denmark        | Purchase & Click with Service      | Minimumsvolumen                           | Cloud MPS Dealer | Cloud  | BOR  | 5 år     | Monthly      | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010149    | A1T010150     | A1T010151     | A1T010152     |
	#| Cloud MPS Local Office Approver | Sweden         | Purchase & click inklusive service | Minimum volym                             | Cloud MPS Dealer | Cloud  | BOR  | 60       | Monthly      | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010153    | A1T010154     | A1T010155     | A1T010156     |
	...
	#| Cloud MPS Local Office Approver | Belgium        | Purchase & Click with Service      | Minimum Volume                            | Cloud MPS Dealer | Cloud  | BOR  | 5 jaar   | Monthly      | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010181    | A1T010182     | A1T010183     | A1T010184     |
	...
	#| Cloud MPS Local Office Approver | Finland        | Purchase & Click with Service      | Minimitulostusmäärä                       | Cloud MPS Dealer | Cloud  | BOR  | 5 vuotta | Monthly      | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010177    | A1T010178     | A1T010179     | A1T010180     |
	#| Cloud MPS Local Office Approver | Switzerland    | Purchase & Click with Service      | Mindestvolumen                            | Cloud MPS Dealer | Cloud  | BOR  | 5 Jahre  | Monthly      | Included in Click Price | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010185    | A1T010186     | A1T010187     | A1T010188     |
	#
...
Scenarios:
	...
	| Role                            | Country        | ContractType                       | UsageType                | Role1            | Method | Type | Length   | Billing                 | ServicePack | Installation | Delivery | Device1      | Device2     | SerialNumber | SerialNumber1 | SerialNumber2 | SerialNumber3 |
	#| Cloud MPS Local Office Approver | France         | Buy & Click                        | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 ans    | Trimestrale anticipata  | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010197    | A1T010198     | A1T010199     | A1T010200     |
	...
	#| Cloud MPS Local Office Approver | Spain          | Purchase & Click con Service       | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 años   | Por trimestres vencidos | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010205    | A1T010206     | A1T010207     | A1T010208     |
	#| Cloud MPS Local Office Approver | Denmark        | Purchase & Click with Service      | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 år     | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010209    | A1T010210     | A1T010211     | A1T010212     |
	#| Cloud MPS Local Office Approver | Sweden         | Purchase & click inklusive service | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 36       | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010213    | A1T010214     | A1T010215     | A1T010216     |
	#| Cloud MPS Local Office Approver | Netherlands    | Purchase + Click met Service       | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 jaar   | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010217    | A1T010218     | A1T010219     | A1T010220     |
	...
	#| Cloud MPS Local Office Approver | Poland         | Buy + Click                        | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 lata   | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010229    | A1T010230     | A1T010231     | A1T010232     |
	...
	#| Cloud MPS Local Office Approver | Belgium        | Purchase & Click with Service      | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 jaar   | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010241    | A1T010242     | A1T010243     | A1T010244     |
	...
	#| Cloud MPS Local Office Approver | Switzerland    | Purchase & Click with Service      | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 3 Jahre  | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010245    | A1T010246     | A1T010247     | A1T010248     |
	#| Cloud MPS Local Office Approver | Finland        | Purchase & Click with Service      | Maksu tulosteiden mukaan | Cloud MPS Dealer | Cloud  | BOR  | 3 vuotta | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010237    | A1T010238     | A1T010239     | A1T010240     |
	#| Cloud MPS Local Office Approver | Norway         | Kjøp og klikk med service          | Pay As You Go            | Cloud MPS Dealer | Cloud  | BOR  | 36       | Quarterly in Arrears    | Pay upfront | Brother      | Yes      | MFC-L8650CDW | MFC-L5750DW | A1T010221    | A1T010222     | A1T010223     | A1T010224     |
	#
