@MPS @TEST @UAT
Feature: CloudMPSIrishDealerCanSignContract
...
Scenario Outline: Dealer Can Sign A Purchase And Click Contract for other countries
	...
	| Cloud MPS Dealer | Ireland | Cloud MPS Local Office Approver | Buy & Click  | Engagement sur un minimum volume de pages | 3 ans  | Trimestrale anticipata |
