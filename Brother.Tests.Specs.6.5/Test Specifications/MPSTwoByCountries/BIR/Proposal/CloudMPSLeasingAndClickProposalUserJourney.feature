@ignore @TEST @UAT @MPS
Feature: CloudMPSIrishLeasingAndClickProposalUserJourney
...
Scenario Outline: Create different varieties of Leasing and Click proposal for an existing customer
	...
	| Cloud MPS Dealer | Ireland | Lease & Click with Service | Minimum Volume | 4 years  | Quarterly in Arrears | Quarterly in Arrears | HL-L8350CDW | Full         | 750         | 750          |
...
Scenario Outline: Create different varieties of Leasing and Click proposal for an existing customer on Pay As You Go
	...
	| Cloud MPS Dealer | Ireland | Lease & Click with Service | Pay As You Go | 5 years  | Quarterly in Arrears | Quarterly in Arrears | DCP-8110DN | Full         | 750         |
