@MPS @TEST @UAT
Feature: CloudMPSIrishClickPriceDeepDive
...
Scenario Outline: Purchase + Click, PAYG, Service Pack not displayed
	...
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Pay As You Go | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-8510DN | Full         | Pay upfront   | 0           | 2000         |
...
Scenario Outline: Purchase + Click, Minimum Volume, Service Pack not displayed
	...
	Scenarios: 
	| Role             | Country | ContractType                  | CreateOption        | UsageType      | Contract | Leasing              | Billing              | PriceHardware | Printer    | DeviceScreen | PaymentMethod | ClickVolume | ColourVolume |
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-8510DN | Full         | Pay upfront   | 0           | 2000         |
...
Scenario Outline: Variation of "In Click" and "Upfront Payment" click price(3)
	...
	Scenarios: 
	| Role             | Country | ContractType                  | CreateOption        | UsageType      | Contract | Leasing              | Billing              | PriceHardware | Printer      | DeviceScreen | PaymentMethod | ClickVolume | ColourVolume |
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Pay upfront   | 0           | 2000         |
...
Scenario Outline: Variation of "In Click" and "Upfront Payment" click price(4)
	...
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Minimum Volume | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Included in Click Price | 6            | 2000        | 2000         |
...
Scenario Outline: No Variation of "In Click" and "Upfront Payment" click price(Purchase & Click)
	...
	Scenarios: 
	| Role             | Country | ContractType                  | CreateOption        | UsageType     | Contract | Leasing              | Billing              | PriceHardware | Printer      | DeviceScreen | PaymentMethod           | ClickVolume | ColourVolume |
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Pay As You Go | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-8510DN   | Full         | Included in Click Price | 2000        | 2000         |
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Create new customer | Pay As You Go | 3 years  | Quarterly in Arrears | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Included in Click Price | 2000        | 2000         |
