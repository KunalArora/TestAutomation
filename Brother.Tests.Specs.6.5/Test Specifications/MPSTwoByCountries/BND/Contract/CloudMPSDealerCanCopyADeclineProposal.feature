...
Scenario Outline: Belgian Dealer Can Copy A Declined Leasing and Click Proposal without customer detail
...
Scenario Outline: Belgian Dealer Can Copy A Declined Leasing and Click Proposal with customer detail
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
	And I have created German Leasing and Click proposal 
	And I am on Proposal List page
	And I send the created German proposal for approval
...
Scenario Outline: Belgian Dealer Can Copy A Declined Purchase and Click Proposal without customer detail
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
...
Scenario Outline: Belgian Dealer Can Copy A Declined Purchase and Click Proposal with customer detail
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
	And I have created Purchase and Click proposal 
	And I am on Proposal List page
	And I send the created proposal to local office approver for approval
...
Scenario Outline: Belgian Dealer Can Copy A Declined Purchase and Click Proposal without customer detail for other countries
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
...
Scenario Outline: Belgian Dealer Can Copy A Declined Purchase and Click Proposal with customer detail for other countries
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
	And I have created a "<ContractType>" proposal with "<UsageType>" and "<Length>" and "<Billing>"
	And I am on Proposal List page
	And I send the created proposal to local office approver for approval
