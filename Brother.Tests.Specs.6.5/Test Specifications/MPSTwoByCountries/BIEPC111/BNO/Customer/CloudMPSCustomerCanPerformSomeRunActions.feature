@ignore @TEST @UAT @MPS @BIEPC111
Feature: NorwegianCustomerCanPerformSomeRunActions
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Norway  | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Email  | Cloud MPS Customer |
