...
namespace Brother.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC110.BES.Proposal
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSSpanishDealerCanGeneratePDFAtRelevantStages")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("TEST")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    public partial class CloudMPSSpanishDealerCanGeneratePDFAtRelevantStagesFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSSpanishDealerCanGeneratePDFAtRelevantStages", "In order to generate Proposal PDF\r\nAs a dealer\r\nI want to create a proposal for w" +
        ...
        [NUnit.Framework.DescriptionAttribute("MPS Spanish Dealer Can Generate PDF for Purchase and Click in Awaiting Approval S" +
        ...
        public virtual void MPSSpanishDealerCanGeneratePDFForPurchaseAndClickInAwaitingApprovalStatusForOtherCountries(string role, string country, string role2, string contractType, string usageType, string length, string billing, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPS Spanish Dealer Can Generate PDF for Purchase and Click in Awaiting Approval S" +
