...
Feature: SpanishCustomerCanPerformSomeRunActions
	In order for customer to perform some run portion actions
	As a customer
	I want to be to sign in using my newly generated credentials


Scenario Outline: MPS Spanish Customer cannot order consumable before initial communication with device
...
Scenario Outline: MPS Spanish Customer can order consumable after initial communication with device
