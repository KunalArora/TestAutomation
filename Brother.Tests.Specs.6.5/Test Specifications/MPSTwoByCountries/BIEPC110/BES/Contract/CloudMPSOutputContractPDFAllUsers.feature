@MPS @TEST @UAT
Feature: CloudMPSOutputContractPDFAllSpanishUsers
	In order to view paper version of contract summary
	As an MPS User
	I want to be able to download contract PDFs

Scenario Outline: MPS Spanish Local Office Approver can download Contract PDFs on Awaiting Acceptance page
...
Scenario Outline: MPS Spanish Local Office Approver can download Contract PDFs on Rejected page
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
...
Scenario Outline: MPS Spanish Dealer can download Contract PDFs on Approved proposal page
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
...
Scenario Outline: MPS Spanish Dealer can download Contract PDFs on Awaiting Acceptance page
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
...
Scenario Outline: MPS Spanish Dealer can download Contract PDFs on Rejected page
	Given I sign into Cloud MPS as a "<Role>" from "<Country>"
