...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Switzerland | Purchase & Click mit Service | Mindestvolumen | Cloud MPS Dealer | Cloud  | Web  | Roxanna20160929030238@mailinator.com  | 36     | Quarterly in Arrears | Cloud MPS Customer |
