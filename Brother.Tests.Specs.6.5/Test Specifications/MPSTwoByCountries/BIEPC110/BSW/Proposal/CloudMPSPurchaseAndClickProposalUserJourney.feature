...
Scenario Outline: Create different varieties of Purchase and Click proposal for new customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Switzerland | Purchase & Click mit Service | Create new customer | Pay As You Go | 48       | Quarterly in Arrears | Tick          | HL-L2360DN | Full         | 750         |
...
Scenario Outline: Create different varieties of Purchase and Click proposal for an existing customer
	...
	| Cloud MPS Dealer | Switzerland | Purchase & Click mit Service | Mindestvolumen | 36       | Quarterly in Arrears | Tick          | MFC-L8650CDW | Full         | Über den Seitenpreis zahlen | 800         | 800          |
...
Scenario Outline: Create different varieties of Purchase and Click proposal for an existing customer on Pay As You Go Term
	...
	| Cloud MPS Dealer | Switzerland | Purchase & Click mit Service | Pay As You Go | 60       | Quarterly in Arrears | Tick          | HL-L2360DN | Full         | 750         |
