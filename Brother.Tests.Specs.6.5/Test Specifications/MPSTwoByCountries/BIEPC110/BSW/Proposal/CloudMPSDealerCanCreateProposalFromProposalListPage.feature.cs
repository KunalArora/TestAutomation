...
namespace Brother.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC110.BSW.Proposal
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSSwissDealerCanCreateProposalFromProposalListPage")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    [NUnit.Framework.CategoryAttribute("TEST")]
    public partial class CloudMPSSwissDealerCanCreateProposalFromProposalListPageFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSSwissDealerCanCreateProposalFromProposalListPage", "In order to create a proposal from proposal list page\r\nAs a dealer\r\nI want create" +
        ...
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Dealer", "Switzerland", "Purchase & Click mit Service", "Quartalsweise", "36", "Quarterly in Arrears", "Tick", "MFC-L8650CDW", "Full", "Über den Seitenpreis zahlen", "800", "800", "Über den Seitenpreis zahlen", "Im Voraus bezahlen", null)]
...
#line 29
 testRunner.And("service pack cost is included click as \"CHF 0.00\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 30
