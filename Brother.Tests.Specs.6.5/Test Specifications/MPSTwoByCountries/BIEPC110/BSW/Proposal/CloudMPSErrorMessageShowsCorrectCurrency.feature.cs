...
namespace Brother.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC110.BSW.Proposal
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSErrorMessageShowsCorrectCurrency")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("TEST")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    [NUnit.Framework.CategoryAttribute("BIEPC110")]
    public partial class CloudMPSErrorMessageShowsCorrectCurrencyFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSErrorMessageShowsCorrectCurrency", "In order to ensure that error message correctly displayed currency\r\nAs a dealer\r\n" +
        ...
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Dealer", "Switzerland", "Purchase & Click mit Service", "Skip customer creation", "Pay As You Go", "48", "Quartalsweise", "Tick", "HL-L5100DN", "750", "CHF", null)]
