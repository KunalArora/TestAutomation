...
namespace Brother.MPS.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC110.BUK.Customer
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("MPS English Customer cannot order consumable before initial communication with de" +
            "vice")]
        ...
        public virtual void MPSEnglishCustomerCannotOrderConsumableBeforeInitialCommunicationWithDevice(string role, string country, string contractType, string usageType, string role1, string method, string role2, string[] exampleTags)
        {
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("MPS English Customer can order consumable after initial communication with device" +
            "")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Customer", "United Kingdom", null)]
        public virtual void MPSEnglishCustomerCanOrderConsumableAfterInitialCommunicationWithDevice(string role, string country, string[] exampleTags)
        {
