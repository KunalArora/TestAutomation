...
Scenario Outline: MPS English Existing Customer can be used to create a new contract for Run purpose
...
Scenarios:
	...
	| Cloud MPS Local Office Approver | United Kingdom | Purchase & Click with Service | Minimum Volume | Cloud MPS Dealer | Cloud  | Web  | Lonna20160514201608@mailinator.com | 3 years | Quarterly in Arrears | Cloud MPS Customer |
