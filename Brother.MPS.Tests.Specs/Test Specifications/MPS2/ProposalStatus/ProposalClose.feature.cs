...
namespace Brother.Tests.Specs.TestSpecifications.MPS2.ProposalStatus
{
    ...
    [NUnit.Framework.DescriptionAttribute("Close Proposal")]
    ...
    public partial class CloseProposalFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "ProposalClose.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Close Proposal", "\tIn order to clearly monitor the progress of created proposals\r\n\tAs a Cloud MPS D" +
                    "ealer\r\n\tI want to verify a proposal successfully goes into the closed state", ProgrammingLanguage.CSharp, new string[] {
                        "MPS",
                        "UAT",
                        "TYPE1",
                        "PROPOSALSTATUS",
        ...
        [NUnit.Framework.TestCaseAttribute("United Kingdom", "PURCHASE_AND_CLICK", "MINIMUM_VOLUME", "QUARTERLY_IN_ARREARS", "PAY_UPFRONT", "THREE_YEARS", new string[] {
                "BUK"}, Category="BUK")]
        public virtual void CloseProposal(string country, string contractType, string usageType, string billingType, string servicePackType, string contractTerm, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Close Proposal", exampleTags);
#line 7
...
#line 18
testRunner.And("I cancel the above proposal and verify the proposal is in closed state", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 19
testRunner.Then("I can verify the proposal is present in the dataquery page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
