...
namespace Brother.Tests.Specs.TestSpecifications.MPS2.ProposalStatus
{
    ...
    [NUnit.Framework.DescriptionAttribute("Decline Proposal")]
...
#line 1 "ProposalDeclined.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Decline Proposal", "\tIn order to clearly monitor the progress of created proposals\r\n\tAs a Cloud MPS D" +
                    "ealer\r\n\tI want to see a proposal which has been declined in the Declined list", ProgrammingLanguage.CSharp, new string[] {
                        "MPS",
                        "UAT",
                        "DEV",
                        "TYPE1",
        ...
        [NUnit.Framework.TestCaseAttribute("United Kingdom", "PURCHASE_AND_CLICK", "MINIMUM_VOLUME", "QUARTERLY_IN_ARREARS", "PAY_UPFRONT", "THREE_YEARS", new string[] {
                "BUK"}, Category="BUK")]
        public virtual void DeclineProposal(string country, string contractType, string usageType, string billingType, string servicePackType, string contractTerm, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Decline proposal", exampleTags);
#line 7
