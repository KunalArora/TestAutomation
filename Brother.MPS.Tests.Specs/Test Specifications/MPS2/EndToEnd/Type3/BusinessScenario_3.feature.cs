...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("United Kingdom", "Yes", "Minimum Volume", "5 years", "Included in Click Price", "Yes", new string[] {
                "BUK"}, Category="BUK")]
        public virtual void BusinessScenario3(string country, string nonMandatory_1, string usageType, string contractTerm, string service, string nonMandatory_2, string[] exampleTags)
        {
...
#line 18
testRunner.And(string.Format("I edit device data using excel edit option (\"{0}\" fields also)", nonMandatory_2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 19
