...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("United Kingdom", "Yes", "Minimum Volume", "5 years", "Included in Click Price", new string[] {
                "BUK"}, Category="BUK")]
        public virtual void BusinessScenario3(string country, string nonMandatory_1, string usageType, string contractTerm, string service, string[] exampleTags)
        {
