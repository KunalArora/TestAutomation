...
And I add these printers:
		...
		| DCP-8110DN   | 1000.00 | Brother-Install | Yes      | 5            | 1000       | 0              | 0            | A3P145620    | 23             | 100             | Empty               | Normal             | Normal                | Normal               | Normal    | Empty     | Normal           | Normal           | Normal           | true   |
		| HL-5450DN    | 1000.00 | Brother-Install | Yes      | 5            | 1000       | 0              | 0            | A3P145621    | 0              | 0               | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
		| DCP-L8450CDW | 1000.00 | Brother-Install | Yes      | 5            | 1000       | 20             | 250          | A3P145622    | 0              | 0               | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
		| MFC-L8650CDW | 1000.00 | Brother-Install | Yes      | 5            | 1000       | 20             | 200          | A3P145623    | 0              | 0               | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
...
Scenarios: 
		...
		| United Kingdom | Purchase & Click | Minimum Volume | Quarterly in Arrears | Pay upfront     | 3 years      | New      | Cloud               | Web              | ReplaceWithSameModel | A3P145626                 | 100                         | 0                          |
#@BFR
#Scenarios:
