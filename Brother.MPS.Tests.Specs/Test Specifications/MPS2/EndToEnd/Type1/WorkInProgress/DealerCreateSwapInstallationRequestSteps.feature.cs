...
namespace Brother.Tests.Specs.TestSpecifications.MPS2.EndToEnd.Type1.WorkInProgress
{
    ...
    [NUnit.Framework.DescriptionAttribute("BusinessScenario_1_WIP_DealerCreateSwapInstallationRequestSteps")]
    [NUnit.Framework.CategoryAttribute("MPS")]
    [NUnit.Framework.CategoryAttribute("UAT")]
    [NUnit.Framework.CategoryAttribute("TYPE1")]
    [NUnit.Framework.CategoryAttribute("WORKINPROGRESS")]
    public partial class BusinessScenario_1_WIP_DealerCreateSwapInstallationRequestStepsFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "DealerCreateSwapInstallationRequestSteps.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "BusinessScenario_1_WIP_DealerCreateSwapInstallationRequestSteps", "\tIn order to initiate the swap of an installed Cloud MPS device for a contract\r\n\t" +
                    "As a Cloud MPS Dealer\r\n\tI want to create a swap installation request", ProgrammingLanguage.CSharp, new string[] {
                        "MPS",
                        "UAT",
                        "TYPE1",
                        "WORKINPROGRESS"});
