...
And I add these printers:
		...
		| DCP-8110DN   | 1000.00 | DEALER_INSTALLATION_TYPE1 | No       | 5            | 1000       | 0              | 0            | A3P145620    | 0              | 0               | Empty               | Normal             | Normal                | Normal               | Normal    | Empty     | Normal           | Normal           | Normal           | true   |
		| HL-5450DN    | 1000.00 | DEALER_INSTALLATION_TYPE1 | No       | 5            | 1000       | 0              | 0            | A3P145621    | 0              | 0               | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
		| DCP-L8450CDW | 1000.00 | DEALER_INSTALLATION_TYPE1 | No       | 5            | 1000       | 20             | 250          | A3P145622    | 1000           | 250             | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
		| MFC-L8650CDW | 1000.00 | DEALER_INSTALLATION_TYPE1 | No       | 5            | 1000       | 20             | 200          | A3P145623    | 0              | 0               | Normal              | Normal             | Normal                | Normal               | Normal    | Normal    | Normal           | Normal           | Normal           | false  |
...
And I apply overusage to the contract depending on usagetype and billingtype
...
Scenarios: 
		...
		| United Kingdom | PURCHASE_AND_CLICK | MINIMUM_VOLUME | HALF_YEARLY | INCLUDED_IN_CLICK_PRICE | FOUR_YEARS   | Existing | Cloud               | Web              | 
