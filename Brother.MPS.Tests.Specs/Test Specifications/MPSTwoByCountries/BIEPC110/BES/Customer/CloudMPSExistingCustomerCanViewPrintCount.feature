...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Spain   | Purchase & Click con Service | Volúmen mínimo | Cloud MPS Dealer | Cloud  | Web  | Bradon20170626091009@mailinator.com | 3 años | Por trimestres vencidos | Cloud MPS Customer |
