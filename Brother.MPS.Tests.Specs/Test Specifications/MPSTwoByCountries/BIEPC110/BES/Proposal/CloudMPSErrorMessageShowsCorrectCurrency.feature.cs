...
namespace Brother.MPS.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC110.BES.Proposal
{
    ...
    [NUnit.Framework.DescriptionAttribute("CloudMPSErrorMessageShowsCorrectSpanishCurrency")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSErrorMessageShowsCorrectSpanishCurrency", "In order to ensure that error message correctly displayed currency\r\nAs a dealer\r\n" +
        ...
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Dealer", "Spain", "Purchase & Click con Service", "Skip customer creation", "Pago por Uso", "3 años", "Por trimestres vencidos", "Tick", "MFC-L5750DW", "750", "€", null)]
