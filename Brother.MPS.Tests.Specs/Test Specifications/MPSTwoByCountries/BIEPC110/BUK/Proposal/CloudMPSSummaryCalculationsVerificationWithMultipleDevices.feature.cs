...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSSummaryCalculationsVerificationWithMultipleDevices", "\tIn order to validate that number of devices influences the display of print coun" +
                    "ts on summary pages\r\n\tAs a dealer \r\n\tI want to create a proposal with multiple d" +
                    "evices", ProgrammingLanguage.CSharp, new string[] {
                        "TEST",
                        "UAT",
                        "MPS",
                        "BIEPC110"});
