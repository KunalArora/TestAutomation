...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CloudMPSDataQuerySearchAndFilterVerification", "\tIn order verify that all search and filters are working on Data Query page\r\n\tAs " +
                    "a LO Approver\r\n\tI want to be able to filter all the results displayed on the Dat" +
                    "a Query page", ProgrammingLanguage.CSharp, new string[] {
                        "MPS",
                        "TEST",
                        "UAT",
                        "BIEPC110"});
...
#line 11
 testRunner.Then("I can search with contract id \"115287\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 12
