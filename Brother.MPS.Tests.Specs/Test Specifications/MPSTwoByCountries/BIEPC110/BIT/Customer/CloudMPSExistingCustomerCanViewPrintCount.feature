...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Italy   | Acquisto + Consumo con assistenza | Volume minimo | Cloud MPS Dealer | Cloud  | Web  | Delsie20160322121420@mailinator.com | 36     | Trimestrale anticipata | Cloud MPS Customer |
