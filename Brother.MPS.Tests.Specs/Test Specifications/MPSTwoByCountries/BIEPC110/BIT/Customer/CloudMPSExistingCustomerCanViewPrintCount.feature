...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Italy   | Acquisto + Consumo con assistenza | Volume minimo | Cloud MPS Dealer | Cloud  | Web  | Lashonda20170629030857@mailinator.com | 36     | Trimestrale anticipata | Cloud MPS Customer |
