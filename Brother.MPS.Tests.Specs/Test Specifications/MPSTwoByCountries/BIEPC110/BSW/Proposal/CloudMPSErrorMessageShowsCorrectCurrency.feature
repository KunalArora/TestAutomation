...
Feature: CloudMPSErrorMessageShowsCorrectCurrency
...
Scenario Outline: Currency in product screen error message
	...
	| Cloud MPS Dealer | Switzerland | Purchase & Click mit Service | Skip customer creation | Pay As You Go | 48       | Quartalsweise | Tick          | HL-L5100DN | 750         | CHF      |
