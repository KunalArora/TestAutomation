...
Scenario Outline: Currency in product screen error message
	...
	| Cloud MPS Dealer | France  | Buy & Click  | Skip customer creation | Paiement selon la consommation réelle de pages | 3 ans    | Trimestriellement à terme échu | Tick          | MFC-L5750DW | 750         | €        |
