...
Scenarios:
	...
	| Cloud MPS Local Office Approver | France  | Buy & Click  | Engagement sur un minimum volume de pages | Cloud MPS Dealer | Cloud  | Web  | Convest20170627082940@mailinator.com | 3 ans  | Trimestrale anticipata | Cloud MPS Customer |
