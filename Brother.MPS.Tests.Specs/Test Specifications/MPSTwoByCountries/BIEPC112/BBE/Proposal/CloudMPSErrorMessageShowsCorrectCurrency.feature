...
Feature: CloudMPSErrorMessageShowsCorrectBelgianCurrency
...
Scenario Outline: Currency in product screen error message
	...
	| Cloud MPS Dealer | Belgium | Buy & Click  | Skip customer creation | Volume minimum | 3 ans    | Driemaandelijks, betaling vooraf / Paiement trimestriel à l’avance | Tick          | MFC-L5750DW | 750         | €        |
