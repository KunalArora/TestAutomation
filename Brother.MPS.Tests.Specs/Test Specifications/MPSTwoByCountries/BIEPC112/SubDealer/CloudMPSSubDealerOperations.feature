...
Scenario Outline: Local Office Admin can create dealership users
	...
	| Cloud MPS Dealer | United Kingdom | Full             | MPS-BUK-UAT-Dealer1 |
	| Cloud MPS Dealer | United Kingdom | Contract Manager | MPS-BUK-UAT-Dealer1 |
	| Cloud MPS Dealer | United Kingdom | Restricted       | MPS-BUK-UAT-Dealer1 |
