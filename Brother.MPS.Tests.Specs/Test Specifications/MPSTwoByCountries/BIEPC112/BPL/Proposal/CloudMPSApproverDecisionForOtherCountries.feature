...
Scenario Outline: MPS Dealer Resign Rejected Contract
	...
	| Poland  | Cloud MPS Local Office Approver | Buy + Click  | Pakiet wydruków | 3 lata | Miesięczny / Monthly | Cloud MPS Dealer |
...
Scenario Outline: MPS LO View Contracts
	...
	| Cloud MPS Local Office Approver | Poland  | Awating Acceptance |
	| Cloud MPS Local Office Approver | Poland  | Rejected           |
	| Cloud MPS Local Office Approver | Poland  | Accepted           |
