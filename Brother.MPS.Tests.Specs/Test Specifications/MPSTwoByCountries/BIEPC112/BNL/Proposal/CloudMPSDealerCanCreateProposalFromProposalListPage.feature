...
Feature: CloudMPSDutchDealerCanCreateProposalFromProposalListPage
...
Scenarios: 
	...
	| Cloud MPS Dealer | Netherlands | Purchase + Click met Service | Minimumvolume | 3 jaar   | 3-maandelijks achteraf | Tick          | MFC-L8650CDW | Full         | Voorafbetaling | 800         | 800          | Opgenomen in klikprijs | Voorafbetaling |
