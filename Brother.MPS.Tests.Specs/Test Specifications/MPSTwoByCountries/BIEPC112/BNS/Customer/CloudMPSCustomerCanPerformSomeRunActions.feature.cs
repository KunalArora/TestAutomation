...
namespace Brother.MPS.Tests.Specs.TestSpecifications.MPSTwoByCountries.BIEPC112.BNS.Customer
{
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("MPS Swedish Customer cannot order consumable before initial communication with de" +
            "vice")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Local Office Approver", "Sweden", "Purchase & Click with Service", "Minimum Volume", "Cloud MPS Dealer", "Email", "Cloud MPS Customer", null)]
        public virtual void MPSSwedishCustomerCannotOrderConsumableBeforeInitialCommunicationWithDevice(string role, string country, string contractType, string usageType, string role1, string method, string role2, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPS Swedish Customer cannot order consumable before initial communication with de" +
                    "vice", exampleTags);
#line 8
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("MPS Swedish Customer can order consumable after initial communication with device" +
            "")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Customer", "Sweden", null)]
        public virtual void MPSSwedishCustomerCanOrderConsumableAfterInitialCommunicationWithDevice(string role, string country, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("MPS Swedish Customer can order consumable after initial communication with device" +
                    "", exampleTags);
#line 28
this.ScenarioSetup(scenarioInfo);
#line 29
