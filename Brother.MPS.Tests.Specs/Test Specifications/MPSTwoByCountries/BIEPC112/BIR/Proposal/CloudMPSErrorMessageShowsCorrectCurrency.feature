...
Feature: CloudMPSErrorMessageShowsCorrectIrishCurrency
...
Scenario Outline: Currency in product screen error message
	...
	| Cloud MPS Dealer | Ireland | Purchase & Click with Service | Skip customer creation | Pay As You Go | 3 years  | Quarterly in Arrears | Tick          | MFC-L5750DW | 750         | €        |
