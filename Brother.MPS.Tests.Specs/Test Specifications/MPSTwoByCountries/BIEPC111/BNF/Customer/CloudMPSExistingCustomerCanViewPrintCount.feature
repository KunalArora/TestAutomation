...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Finland | Click tarvikesopimus | Minimitulostusmäärä | Cloud MPS Dealer | Cloud  | Web  | Lashonda20170613004705@mailinator.com | 3 vuotta | 3 kk välein käytön mukaan | Cloud MPS Customer |
