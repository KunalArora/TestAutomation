...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Finland | Click tarvikesopimus | Minimitulostusmäärä | Cloud MPS Dealer | Cloud  | Web  | Omer20170629060715@mailinator.com | 3 vuotta | 3 kk välein käytön mukaan | Cloud MPS Customer |
