...
Scenarios:
	...
	| Cloud MPS Local Office Approver | Norway  | Kjøp og klikk med service | Minimum volum | Cloud MPS Dealer | Cloud  | Web  | Belkis20170530144440@mailinator.com | 36     | Quarterly in Arrears | Cloud MPS Customer |
