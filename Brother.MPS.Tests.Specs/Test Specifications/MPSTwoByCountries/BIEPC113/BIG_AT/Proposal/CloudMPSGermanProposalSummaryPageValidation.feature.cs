...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Germany MPS Purchase Summary Validation MV In Click")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Dealer", "Germany", "Easy Print Pro & Service", "Mindestvolumen", "5 Jahre", "Halbjährlich", "Tick", "MFC-L8650CDW", "über den Seitenpreis zahlen", "800", "800", null)]
        public virtual void GermanyMPSPurchaseSummaryValidationMVInClick(string role, string country, string contractType, string usageType, string contract, string billing, string priceHardware, string printer, string paymentMethod, string clickVolume, string colourVolume, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Germany MPS Purchase Summary Validation MV In Click", exampleTags);
#line 44
this.ScenarioSetup(scenarioInfo);
#line 45
 testRunner.Given(string.Format("I sign into Cloud MPS as a \"{0}\" from \"{1}\"", role, country), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Austria MPS Purchase Summary Validation MV In Click")]
        [NUnit.Framework.TestCaseAttribute("Cloud MPS Dealer", "Austria", "Easy Print Pro & Service", "Mindestvolumen", "5 Jahre", "Halbjährlich", "Tick", "MFC-L8650CDW", "über den Seitenpreis zahlen", "800", "800", null)]
        public virtual void AustriaMPSPurchaseSummaryValidationMVInClick(string role, string country, string contractType, string usageType, string contract, string billing, string priceHardware, string printer, string paymentMethod, string clickVolume, string colourVolume, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Austria MPS Purchase Summary Validation MV In Click", exampleTags);
#line 80
 this.ScenarioSetup(scenarioInfo);
#line 81
 testRunner.Given(string.Format("I sign into Cloud MPS as a \"{0}\" from \"{1}\"", role, country), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line 92
 testRunner.And(string.Format("I enter click price volume of \"{0}\" and \"{1}\"", clickVolume, colourVolume), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 93
 testRunner.Then("the billing basis for product is \"im Voraus bezahlen\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 94
 testRunner.And("the billing basis for Accessory is \"im Voraus bezahlen\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 95
 testRunner.And("the billing basis for Installation is \"im Voraus bezahlen\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 96
 testRunner.And(string.Format("the billing basis for Service Pack is \"{0}\"", paymentMethod), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 97
 testRunner.And("the installation type displayed is correct", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
