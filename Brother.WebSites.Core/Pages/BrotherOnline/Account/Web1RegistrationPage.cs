...
{
    public class Web1RegistrationPage : BasePage
    {
        ...
        public IWebElement Password1TextBox;
        ...
        [FindsBy(How = How.Id, Using = "content_0_twocolumnsformright_0_valVatNumberRequired")]
        public IWebElement
        ...
        [FindsBy(How = How.Id, Using = "Email")]
        public IWebElement EmailAddress1TextBox;
        ...
        [FindsBy(How = How.CssSelector,
            Using = "#form-sign-up > div:nth-child(2) > span.half-col.validation-failed.blur > div")]
        public IWebElement
            LastNameErrorMessageDisplayed;

        [FindsBy(How = How.CssSelector,
            Using = "#form-sign-up > div:nth-child(5) > span.half-col.validation-failed.blur > div")]
        public IWebElement
            CompanyNameErrorMessageDisplayed;

        [FindsBy(How = How.CssSelector,
            Using = "#form-sign-up > div:nth-child(6) > span.half-col.validation-failed.blur > div")]
        public IWebElement
        ...
        [FindsBy(How = How.CssSelector, Using = "#txtTax1")]
        public IWebElement PersonalNiNumberPortugalTextBox;
