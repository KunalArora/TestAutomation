...
{
    public class LocalOfficeAdminExistingDealershipUsersPage : BasePage
    {
        ...
        public LocalOfficeAdminDealershipUsersCreationPage StartSubDealerCreation()
        {
            MpsUtil.ClickButtonThenNavigateToOtherUrl(Driver, SubDealerCreateButton);

            return GetInstance<LocalOfficeAdminDealershipUsersCreationPage>();
        }
