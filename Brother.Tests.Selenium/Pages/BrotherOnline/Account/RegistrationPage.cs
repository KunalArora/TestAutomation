    ...
    public class RegistrationPage : Base.BasePage
    {
        ...
        public void ResetYourPasswordButtonClick()
        {
            if (!WaitForElementToExistByCssSelector("#content_1_ResetPasswordButton"))
            {
                ...
                Assert.AreNotEqual(null, ResetYourPasswordButton);
            }
        ...
        public void PopulateEmailAdressForChangeOfPassword(string emailAddress)
        {
            ...
            AssertIsEqual(emailAddress, GetTextBoxValue("EmailTextBox"), "Email For Password Reset Text Box");
        }
        ...
        public void PopulateCompanyNameTextBox(string companyName)
        {
            ...
            AssertIsEqual(companyName, GetTextBoxValue("CompanyNameTextBox"), "CompanyName Text Box");
        }
        ...
        public void PopulateVatNumberTextBox(string vatNumber)
        {
            ...
            AssertIsEqual(vatNumber, GetTextBoxValue("VatNumberTextBox"), "Vat number Text Box");
        }
        ...
        public void PopulatePasswordTextBox(string password)
        {
            ...
            AssertIsEqual(password.Equals("@@@@@") ? Helper.Password : password, GetTextBoxValue("PasswordTextBox"), "Password Text Box");
        }
        ...
        public void PopulateConfirmPasswordTextBox(string password)
        {
            ...
            AssertIsEqual(password.Equals("@@@@@") ? Helper.Password : password, GetTextBoxValue("ConfirmPasswordTextBox"), "Confirm Password Text Box");
        }

        public void DoNotHaveAnAccountOption()
        {
            DoNotHaveAnAccountOptionButton.Click();
            AssertIsEqual(DoNotHaveAnAccountOptionButton.Selected.ToString(), "True", "Do Not Have An Account Button");
        }
        ...
        public void DoHaveAnAccountOption()
        {
            ...
            AssertIsEqual(DoHaveAnAccountOptionButton.Selected.ToString(), "True", "Do Have An Account Button");
        }

        public void DoNotUseAccountForBusiness()
        {
            DoNotUseMyAccountForBusinessCheckbox.Click();
            AssertIsEqual(DoNotUseMyAccountForBusinessCheckbox.Selected.ToString(), "True", "Do Not Use Account For Business Button");
        }

        public void UseAccountForBusiness()
        {
            UseMyAccountForBusinessCheckbox.Click();
            AssertIsEqual(UseMyAccountForBusinessCheckbox.Selected.ToString(), "True", "Use Account For Business Button");
        }
        ...
        public void CheckTermsAndConditions()
        {
            ...
            AssertIsEqual(AgreeToTermsAndConditions.Selected.ToString(), "True", "Accept Terms and Conditions Button");
        }

        public void PopulatePassword(string password)
        {
            Password.SendKeys(password.Equals("@@@@@") ? Helper.Password : password);
            AssertIsEqual(password.Equals("@@@@@") ? Helper.Password : password, GetTextBoxValue("Password"), "Password");
        }

        public void PopulateEmailAddressTextBox(string emailAddress)
        {
            Assert.AreEqual(false, EmailAddressErrorMessage.Displayed, "Is Email Error message displayed");
            ...
            AssertIsEqual(emailAddress, GetTextBoxValue("Email"), "Email Text Box");
        }

        public void IsErrorMessageDisplayed()
        {
            Assert.AreEqual(true, EmailAddressErrorMessage.Displayed, "Is Error Message Displayed");
        }
    }
}
