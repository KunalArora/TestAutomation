...
namespace Brother.Tests.Selenium.Lib.Pages.BrotherOnline.ThirdParty
{
    ...
    public class GuerillaEmailConfirmationPage : BasePage
    {
        ...
        {
            Assert.AreEqual(true, url.Contains(Helper.CurrentDomain), "Correct URL Domain");
        }
                ...
                foreach (var emailLink in emailLinks)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Assert.AreEqual(HttpStatusCode.OK, responseCode, "HttpStatusCode");
                        }
                    }
                }
            }
        ...
        public void SelectEmail2(string email)
        {
            ...
            Assert.AreEqual(false, foundMail.EmailAddressElement.Displayed, "Is Email Item Displayed");
            WebDriver.SetWebDriverDefaultTimeOuts(WebDriver.DefaultTimeOut.Implicit);
        }
        ...
        public void SelectEmail(string email)
        {
            ...
            Assert.AreEqual(false, emailItem.Displayed, "Is Email Item Displayed");
            WebDriver.SetWebDriverDefaultTimeOuts(WebDriver.DefaultTimeOut.Implicit);
        }
        ...
        public void DeleteEmail(string emailSubject)
        {
            ...
            if (!IsDeleteEmailButtonAvailable())
            {
                if (!IsBackToInboxButtonAvailable())
                {
                    Assert.Fail("Unable to delete email {0}", emailToDelete.EmailSubject);
                }
            }
...
//                    var email = emailToDelete.EmailElement.FindElement(By.XPath("//input[@type='checkbox']"));
        ...
        public void BackToInboxButtonClick()
        {
            ...
            {
                Assert.AreEqual(true, IsBackToInboxButtonAvailable(), "Is back to inbox button available");
            }
        }
