...
namespace Brother.Tests.Selenium.Lib.Pages.BrotherOnline.Checkout
{
    public class CreditCardDetailsPage : BasePage
    {
        ...
        public void SwitchToCreditCardDetailsFrameAddCard()
        {
            ...
            if (element == null)
            {
                Assert.Fail("Unable to Switch to the Credit Card details frame. Could not find CssSelector");
            }
            Helper.MsgOutput("Switching to Credit Card details frame (Add New Card)");
        ...
        public void SwitchToCreditCardDetailsFrameOrderSummary()
        {
            ...
            Helper.MsgOutput("Switching to Credit Card details frame (Order Summary)");
        ...
        public MyPaymentMethodsPage SendPaymentDetailsButtonClick()
        {
            ...
            {
                Assert.Fail("Unable to reference the Send Button element on the Add New Payment Method Page > [{0}]", elementNotVisible);
            }
        ...
        public OrderConfirmationPage SendPaymentButtonClick()
        {
            ...
            {
                Assert.Fail("Unable to reference the Send Button element on the Credit Card Details Page > [{0}]", elementNotVisible);
            }
        ...
        public ManagePlanPage SendEditPaymentButtonClick()
        {
            ...
            {
                Assert.Fail("Unable to reference the Send Button element on the Credit Card Details Page > [{0}] for Edit Payment method", elementNotVisible);
            }
