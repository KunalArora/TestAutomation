...
namespace Brother.Tests.Selenium.Lib.Pages.BrotherOnline.Checkout
{
    public class BillingDetailsPage : BasePage
    {
        ...
        public void PopulatePostCodeTextBox(string postCode)
        {
            ...
            AssertIsEqual(postCode, GetTextBoxValue("RegexPostCodeText"), "Post Code Text Box");
        }

        public void PopulatePhoneNumberTextBox(string phoneNumber)
        {
            PhoneNumberTextBox.SendKeys(phoneNumber);
            AssertIsEqual(phoneNumber, GetTextBoxValue("PhoneNumberText"), "Phone Number Text Box");
        }
    }
}
