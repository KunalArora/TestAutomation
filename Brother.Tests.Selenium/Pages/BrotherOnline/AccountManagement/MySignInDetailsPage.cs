...
namespace Brother.Tests.Selenium.Lib.Pages.BrotherOnline.AccountManagement
{
    public class MySignInDetailsPage : BasePage
    {
        ...
        public void VerifyEmailAddressValue(string emailAddress)
        {
            ...
            Assert.AreEqual(emailAddress, EmailAddressEditBox.GetAttribute("value"), "Email Address");
        }
        ...
        public void ValidateInformationMessageBarStatus(bool displayed)
        {
            ...
            Assert.AreEqual(displayed, InformationMessageBar.Displayed, "Information Message Bar");
        }
    }
}
