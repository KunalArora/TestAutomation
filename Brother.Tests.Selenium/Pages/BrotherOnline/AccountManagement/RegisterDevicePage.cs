    ...
    public class RegisterDevicePage : BasePage
    {
        ...
        public MyPrintersAndDevicesPage ClickContinueButton()
        {
            if (!WaitForElementToExistByCssSelector("#content_2_innercontent_2_GoToNextStepButton"))
            {
                ...
                Assert.AreNotEqual(null, ContinueButton);
            }
        ...
        public void EnterProductSerialCode(string serialCode)
        {
            ...
            AssertIsEqual(serialCode, SerialCodeTextBox.GetAttribute("value"), "Serial Code Text Box");
        ...
        {
            Wait(Helper.DurationType.Second, 6); // pause for element to be populated. Explicit wait can cause StaleElement exception
        ...
        public void EnterPurchaseDate(string purchaseDate)
        {
            ...
            AssertIsEqual(purchaseDate, PurchaseDateTextBox.GetAttribute("value"), "Purchase Date Text Box");
        }
        ...
        public void EnterPromoCode(string promoCode)
        {
            ...
            AssertIsEqual(promoCode, PromoCodeTextBox.GetAttribute("value"), "PromoCode Text Box");
        }
        ...
        public void EnterSupplier(string supplier)
        {
            ...
            AssertIsEqual(supplier, SupplierTextBox.GetAttribute("value"), "Supplier Text Box");
        }
        ...
        public void TickExtendedWarrantyOption(bool ticked)
        {
            ...
            if (PurchaseExtendedWarrantyOption.Selected != ticked)
            {
                ...
                if (PurchaseExtendedWarrantyOption.Selected != ticked)
                {
                    Assert.Fail("Extended warranty tickbox does not match required ticked status");
                }
            }
            AssertIsEqual(PurchaseExtendedWarrantyOption.Selected.ToString(), ticked.ToString(), "Purchase Extended Warranty Button");
        }
        ...
        public void AgreeToBrotherTermsAndConditions()
        {
            ...
            AssertIsEqual(BrotherTermsAndConditionsTickBox.Selected.ToString(), "True", "Agree to Brother terms and conditions Button");
        }
    }
}
