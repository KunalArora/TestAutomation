...
{
    public class CloudExistingProposalPage : Base.BasePage
    {
        ...
        public void IsNewProposalTemplateCreated()
        {
            ...
            Assert.True(newProposal.Displayed);
        }
        ...
        public void IsProposalSuccessfullySentToBank()
        {
            ...
            Assert.False(proposalContainer.Contains(createdProposal));
        ...
        {
            var createdProposal = ScenarioContext.Current["GeneratedProposalName"].ToString();
