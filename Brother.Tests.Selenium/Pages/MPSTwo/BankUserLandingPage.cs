...
{
    public class BankUserLandingPage : Base.BasePage
    {
        ...
        public void FillAcceptanceForm()
        {
            ...
            Assert.IsNotNullOrEmpty(BankCompanyNameField.GetAttribute("value"));
        ...
        private void VerifyContractIsNoLongerOnOpenOffer()
        {
            ...
            Assert.False(refContainer.Contains(enteredContractRef));

        }

        private static string EnteredContractRef()
        {
            var enteredContractRef = ScenarioContext.Current["GeneratedLeadCodeReference"].ToString();
        ...
        private void VerifyContractIsNowOnConfirmedOffer()
        {
            ...
            var enteredContractName = ScenarioContext.Current["GeneratedProposalName"].ToString();
            var enteredContractRef = EnteredContractRef();
            var refContainer = new ArrayList();
            ...
            Assert.True(refContainer.Contains(enteredContractRef));
            Assert.True(nameContainer.Contains(enteredContractName));
        }
        ...
        public void MaintainContractOffer()
        {
            ...
            Assert.IsNotNullOrEmpty(BankContractReferenceField.GetAttribute("value"));
