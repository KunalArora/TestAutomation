...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("SMOKE_ProductListings")]
        ...
        public virtual void ViewTheListOfAvailableLaserPrintersOnBrotherMainSites(string country, string site, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("View the list of available Laser Printers on Brother Main sites", @__tags);
#line 8
